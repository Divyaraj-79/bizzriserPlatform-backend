...
let MessagingController = class MessagingController {
    ...
    async getMedia(mediaId, accountId, req, res) {
        const media = await this.messagingService.downloadMedia(req.user.orgId, accountId, mediaId);
        if (!media) {
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], MessagingController.prototype, "getMedia", null);
