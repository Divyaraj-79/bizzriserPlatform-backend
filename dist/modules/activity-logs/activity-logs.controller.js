...
let ActivityLogsController = class ActivityLogsController {
    ...
    constructor(activityLoggerService) {
        this.activityLoggerService = activityLoggerService;
    }
    async findAll(req, page = '1', limit = '10', userId) {
...
__decorate([
    (0, common_1.Get)(),
    (0, permissions_decorator_1.Permissions)('view:activity-logs'),
...
exports.ActivityLogsController = ActivityLogsController = __decorate([
    ...
    __metadata("design:paramtypes", [activity_logger_service_1.ActivityLoggerService])
